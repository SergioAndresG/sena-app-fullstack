          ...
          <div class="modal-content">
            <div class="warning-section">
              ...
              <div class="warning-content">
                ...
                <p v-if="selectedUser">
                  Se eliminará permanentemente a <strong>{{ selectedUser.nombre }} {{ selectedUser.apellidos }}</strong>
                  <br>
                  <span class="user-email">{{ selectedUser.correo }}</span>
                </p>
                <p v-else>Se eliminará el usuario seleccionado.</p>
              </div>
            </div>
...
const emit = defineEmits<{
  ...
  'instructor-deleted': [userId: number];
...
const eliminarInstructor = async () => {
  ...
  try {
    ...
    await Swal.fire({
      ...
      text: `${props.selectedUser?.nombre || 'El usuario'} ha sido eliminado exitosamente.`,
    ...
    if (props.selectedUser) {
      emit('user-deleted', props.selectedUser);
    }
...
.delete-button {
  ...
  /* SIMPLIFICADO: box-shadow removido */
  min-width: 160px;
}

.delete-button:hover:not(:disabled) {
  background: #dc2626;
  /* REMOVIDO: transforms y shadows por performance */
}
